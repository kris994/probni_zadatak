...
describe User do
  ...
  describe "micropost associations" do
    ...
    # if a micropost that was deleted has associated microposts, delete them as well
    it "should destroy associated microposts" do
      microposts = @user.microposts.to_a
      @user.destroy
      # associated microposts can not be empty
      expect(microposts).not_to be_empty
      microposts.each do |micropost|
        # the micropost that associated microposts are linked to, has to be empty
